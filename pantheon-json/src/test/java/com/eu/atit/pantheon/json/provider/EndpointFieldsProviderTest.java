package com.eu.atit.pantheon.json.provider;

import com.eu.atit.pantheon.json.annotations.Location;
import com.eu.atit.pantheon.json.annotations.Protected;
import com.eu.atit.pantheon.json.provider.functions.FieldValueSetter;
import com.eu.atit.pantheon.json.provider.functions.JsonString;
import com.eu.atit.pantheon.json.provider.functions.ValueJsonValuePair;
...
import static com.eu.atit.pantheon.json.provider.EndpointFieldsProvider.MULTIPLE_LOCATION_MSG;
import static com.eu.atit.pantheon.json.provider.EndpointFieldsProvider.NO_LOCATION_MSG;
