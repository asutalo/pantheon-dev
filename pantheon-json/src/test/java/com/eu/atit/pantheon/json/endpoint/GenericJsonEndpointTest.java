...
import com.eu.atit.pantheon.exceptions.PantheonProviderException;
...
class GenericJsonEndpointTest {
    ...
    void shouldThrowExceptionWhenClassNotAnnotated() {
        ...
        Assertions.assertEquals("@ServedBy annotation missing for type: class com.eu.atit.pantheon.json.endpoint.GenericJsonEndpointTest$TestClassNotServed", pantheonProviderException.getMessage());
    }
